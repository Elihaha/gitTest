...
//            e.printStackTrace();
    ...
    public Result save(PostageConfigInsertPojo postageConfig) {
        ...
        postageConfigDao.save(postageConfig.castPostageConfigEntity(id));
        return Result.ok();
    }
...
//        Integer id = user.getId();
        Integer id = 2;
        PostageConfigEntity t = postageConfig.castPostageConfigEntity(id);
        t.setCreateTime(null);
        return Result.ok(postageConfigDao.update(t));
    }
