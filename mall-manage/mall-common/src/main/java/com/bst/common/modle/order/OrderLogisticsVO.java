...
public class OrderLogisticsVO implements Serializable {
    ...
    public OrderLogisticsVO(String id, String orderNo, String goodsName, Integer goodsCount, String signer, String signerPhone, String province, String city, String area, String address, String postcode, String dhl, String trackingNumber, String inputTime, Long inputUser, String lastUpdate, String lastOperator, Integer status) {
        this.id = id;
