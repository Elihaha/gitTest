...
@Service("orderLogisticsHService")
@Transactional(readOnly = false, rollbackFor = Exception.class,propagation = Propagation.REQUIRED)
public class OrderLogisticsHServiceImpl implements OrderLogisticsHService {
	@Autowired
	private OrderLogisticsDao orderLogisticsDao;
	
	@Override
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
	public Result queryObject(String id){
		//   根据主订单id  获取  物流编号
		OrderLogisticsEntity orderLogisticsEntity = orderLogisticsDao.getOrderLogisticsEntitiesByMainNo(id);
